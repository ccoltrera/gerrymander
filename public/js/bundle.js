...
var Modal = require('./util/Modal.jsx');
...
var FooterContainer = React.createClass({displayName: "FooterContainer",
  ...
  closeModal: function() {
    this.setStat({isModaleOpen: false});
  },
  render: function() {
    return (
      React.createElement("footer", null, 
        React.createElement("ul", {id: "mainMenue", role: "navigation"}, 
          React.createElement("li", null, 
            React.createElement("a", {link: "#", onclick: this.openModal}, React.createElement("span", {className: "text"}, "PEOPE"), 
            React.createElement("span", {className: "icon"}))
          ), 
          React.createElement("li", null, 
            React.createElement("a", {link: "#", onclick: this.openModal}, React.createElement("span", {className: "text"}, "JOBS"), 
            React.createElement("span", {className: "icon"}))
          ), 
          React.createElement("li", null, 
            React.createElement("a", {link: "#", onclick: this.openModal}, React.createElement("span", {className: "text"}, "HOUSING"), 
            React.createElement("span", {className: "icon"}))
          ), 
          React.createElement("li", null, 
            React.createElement("a", {link: "#", onclick: this.openModal}, React.createElement("span", {className: "text"}, "ECONOMIC"), 
            React.createElement("span", {className: "icon"}))), 
          React.createElement("li", null, 
            React.createElement("a", {link: "#", onclick: this.openModal}, React.createElement("span", {className: "text"}, "EDUCATION"), 
            React.createElement("span", {className: "icon"}))
          )
        ), 
        React.createElement(Modal, {isOpen: this.state.isModalOpen, 
                   transitionName: "modal-anim"}, 
          React.createElement("h3", null, "My Modal"), 
          React.createElement("div", {className: "body"}, 
            React.createElement("p", null, "This is the modal's body.")
          ), 
...
},{"./util/Modal.jsx":185,"react/addons":4}],181:[function(require,module,exports){
'use strict';
var React = require('react');
